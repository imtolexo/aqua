...
func TestInputParameters(t *testing.T) {
	...
	Convey("The Invoker", t, func() {
		...
		Convey("Should correctly identify multi inpParamsut parameters", func() {
			...
			So(i.inpParams[2], ShouldEqual, "i:github.com/imtolexo/aqua.iInvoker")
			So(i.inpParams[3], ShouldEqual, "st:github.com/imtolexo/aqua.invokerMock")
			So(i.inpParams[4], ShouldEqual, "*st:github.com/imtolexo/aqua.invokerMock")
		})
	})
}
...
func TestOutputParameters(t *testing.T) {
	...
	Convey("The Invoker", t, func() {
		...
		Convey("Should correctly identify multi outParamsput parameters", func() {
			...
			So(i.outParams[2], ShouldEqual, "i:github.com/imtolexo/aqua.iInvoker")
			So(i.outParams[3], ShouldEqual, "st:github.com/imtolexo/aqua.invokerMock")
			So(i.outParams[4], ShouldEqual, "*st:github.com/imtolexo/aqua.invokerMock")
		})
	})
}
